...
A knowledge base built and maintained by LLM, following the [LLM Wiki](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f) pattern by Andrej Karpathy.
...
**Entities:**
- [[ai-agent-architecture/entities/anthropic|Anthropic]] - Claude, agentskills.io
- [[ai-agent-architecture/entities/langchain|LangChain]] - LangGraph, Deep Agents
- [[ai-agent-architecture/entities/nvidia|NVIDIA]] - OpenShell, GPU ecosystem
- [[ai-agent-architecture/entities/skillnet|SkillNet]] - Skill ontology platform
- [[ai-agent-architecture/entities/memento-skills|Memento-Skills]] - Self-evolving framework
...
1. **Ingest** - Feed sources, LLM builds structured wiki pages
2. **Query** - Ask questions, answers get filed back into the wiki
3. **Lint** - Health-check for contradictions, gaps, and stale content
